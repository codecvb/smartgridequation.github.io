---
title: Python实现视频目标检测与轨迹跟踪流程详解转载
slug: python实现视频目标检测与轨迹跟踪流程详解转载
category: 人工智能
summary: 更新时间：2023年01月28日 09:38:00   作者：倾城一少
tags: 人工智能, Python
---
...
-   [一、原理](https://www.jb51.net/article/273473.htm#_label0 "一、原理")
-   [二、代码实现](https://www.jb51.net/article/273473.htm#_label1 "二、代码实现")
    -   [1.增加多模板匹配机制](https://www.jb51.net/article/273473.htm#_lab2_1_0 "1.增加多模板匹配机制")
    -   [2.增加轨迹平滑](https://www.jb51.net/article/273473.htm#_lab2_1_1 "2.增加轨迹平滑")
-   [三、测试对比](https://www.jb51.net/article/273473.htm#_label2 "三、测试对比")
...
![](/uploads/csdn/python实现视频目标检测与轨迹跟踪流程详解转载/img-01.png)
...
![](/uploads/csdn/python实现视频目标检测与轨迹跟踪流程详解转载/img-02.png)
...
![](/uploads/csdn/python实现视频目标检测与轨迹跟踪流程详解转载/img-03.png)


![](/uploads/csdn/python实现视频目标检测与轨迹跟踪流程详解转载/img-04.png)


![](/uploads/csdn/python实现视频目标检测与轨迹跟踪流程详解转载/img-05.png)
...
![](/uploads/csdn/python实现视频目标检测与轨迹跟踪流程详解转载/img-06.gif)
...
![](/uploads/csdn/python实现视频目标检测与轨迹跟踪流程详解转载/img-07.gif)


对应的飞行轨迹如下。


![](/uploads/csdn/python实现视频目标检测与轨迹跟踪流程详解转载/img-08.gif)


可以看到，相较于单模版匹配，能较好地提取运动目标和轨迹。而采用之前的单模版匹配算法，经过测试在刚转弯时就跟丢了，如下。


![](/uploads/csdn/python实现视频目标检测与轨迹跟踪流程详解转载/img-09.png)
